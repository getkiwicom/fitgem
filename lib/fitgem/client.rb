...
module Fitgem
  class Client
    ...
    # Reconnect to the fitbit API with a stored oauth token
    #
    # This method should be used if you have previously directed a user
    # through the OAuth process and received a token that
    ...
    #
    # @return [OAuth2::AccessToken] An oauth access token; this is not
    ...
    def authentication_request_token(opts={})
      consumer.options[:authorize_path] = '/oauth2/authenticate'
      request_token(opts)
    end
